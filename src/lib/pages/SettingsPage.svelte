...
<form>
  ...
  <input
    ...
    on:change={() => handleColorPick('primary', primaryColor)}
  />
  <input
    type="color"
    id="primary-hover"
    name="primary-hover"
    bind:value={primaryHover}
    on:change={() => handleColorPick('primary-hover', primaryHover)}
  />
  ...
  <input
    ...
    bind:value={primaryInverse}
    on:change={() => handleColorPick('primary-inverse', primaryInverse)}
  />
